...
const ClientCard: React.FC<ClientDTOPlaceholder> = (clientInfo) => {
  return (
    <div className="bg-gradient-to-r from-dark-blue-6 to-deeper-blue hover:from-[#35474c] hover:to-[#6d939d] w-full border-beige border border-solid flex flex-row justify-between p-6">
