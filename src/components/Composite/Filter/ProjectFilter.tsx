...
import { DefaultDropdownOptions, SortableKeys } from '@/components/Generic/Filter/ProjectFilterAssets';
...
const ProjectFilter : React.FC<ProjectFilterProps> = ({
    ...
    return (
        <div className="relative"  ref={wrapperRef}>
            <div className=" hover:cursor-pointer flex items-center" onClick={() => setShowDropdown(!showDropdown)}>
              <p className="text-sm font-semibold text-grey-1">Filter by</p><ChevronDownIcon className='h-5 text-grey-1'/></div>
            {showDropdown && (
                <div className={`absolute top-full right-0 mt-2 z-20 max-w-40`} style={{ width: newMaxWidth }}>
