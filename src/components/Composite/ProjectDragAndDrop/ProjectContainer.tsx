...
const ProjectContainer = ({
  ...
  const {
    ...
    const dotColor = containerColor == 'light' ? 'text-bright-blue' : containerColor == 'medium' ? 'text-deeper-blue' : 'text-dark-blue-1';
    const dividerColor = containerColor == 'light' ? 'bg-bright-blue' : containerColor == 'medium' ? 'bg-deeper-blue' : 'bg-dark-blue-1';
    return (
        <div
        {...attributes}
        ref={(el) => {
                ...
                <div className="flex items-center w-full justify-between">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 ${dotColor}`}>
