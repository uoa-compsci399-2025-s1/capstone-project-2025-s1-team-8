...
import { ProjectCardType, ProjectDTOPlaceholder} from '@/components/Generic/ProjectCard/ProjectCard';
    ...
    function sortProjects(containerId: UniqueIdentifier, filter: string): void {
        setContainers(prevContainers => {
          return prevContainers.map(container => {
            ...
            switch (filter) {
              case "projectName":
                sortedItems.sort((a, b) => a.projectInfo.projectName.localeCompare(b.projectInfo.projectName));
                break;
              case "clientName":
                sortedItems.sort((a, b) => a.projectInfo.client.name.localeCompare(b.projectInfo.client.name));
                break;
              case "submissionDate":
                sortedItems.sort(
                  (a, b) => new Date(a.projectInfo.submissionDate).getTime() - new Date(b.projectInfo.submissionDate).getTime()
                );
                break;
              default:
