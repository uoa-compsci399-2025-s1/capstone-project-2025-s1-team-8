  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`z-50 p-3 flex items-center justify-center transition-transform duration-200 rounded-full shadow-lg bg-gradient-to-tl from-deeper-blue to-muted-blue cursor-pointer ${
