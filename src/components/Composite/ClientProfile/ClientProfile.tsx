  ...
  return (
    <div className="w-full h-[685px] relative bg-light-beige rounded-2xl ring-1 ring-deeper-blue p-8 pt-10 pb-14 overflow-y-auto">
      ...
      <div className="grid grid-cols-[max-content_auto] gap-3 pb-8">
            ...
            <Capsule text="Affiliation" variant="muted_blue" className="ring-1 ring-muted-blue col-start-1 mr-5"/>
            {clientInfo.affiliation ? <Capsule text={clientInfo.affiliation} variant="beige" className="col-start-2"/> : null}
      </div>
      <div>
